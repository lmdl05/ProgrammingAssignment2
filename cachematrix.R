## A Function that uses the scoping properties of R to cache the value of a matrix's inverse.


## Creates a list containing a function to set or get the value of a matrix. 
## It also includes 2 functions to set or get the value of the inverse. 
